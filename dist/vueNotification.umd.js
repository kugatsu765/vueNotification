...
/* harmony default export */ var Notificationvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    remove: function remove() {
      ...
      }).to(".notif".concat(this.uuid, ">div"), 0.3, {
        opacity: 0
    ...
    animate: function animate() {
      var tl = new TimelineMax().from(".notif".concat(this.uuid), 0.6, {
        opacity: 0
      }).from(".notif".concat(this.uuid), 0.4, {
        borderRadius: 100,
        width: 30,
        height: 30
...
var NotificationCenter = {
  install: function install(Vue) {
    ...
    Vue.prototype.$notification = {
      new: function _new(message, lConf) {
        lConf.type = "primary";
        lConf.message = message;
        return createNotification(lConf);
      },
      success: function success(message, lConf) {
        lConf.type = "success";
        lConf.message = message;
        return createNotification(lConf);
      },
      error: function error(message, lConf) {
        lConf.type = "error";
        lConf.message = message;
        return createNotification(lConf);
      },
      warning: function warning(message, lConf) {
        lConf.type = "warning";
        lConf.message = message;
        return createNotification(lConf);
      },
      info: function info(message, lConf) {
        lConf.type = "info";
        lConf.message = message;
        return createNotification(lConf);
      },
